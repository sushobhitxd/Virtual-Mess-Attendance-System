...
- After training model click on `Automatic Attendance` ,you have to enter the Meal name and then it can fill attendace by your face using our trained model.
- it will create `.csv` file for every Meal you enter and seperate every `.csv` file accoriding the Meal
